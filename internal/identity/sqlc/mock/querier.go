...
func (mr *MockQuerierMockRecorder) ListUsersByHousehold(ctx, householdID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListUsersByHousehold", reflect.TypeOf((*MockQuerier)(nil).ListUsersByHousehold), ctx, householdID)
}

// ListUsersByIDs mocks base method.
func (m *MockQuerier) ListUsersByIDs(ctx context.Context, dollar_1 []int64) ([]sqlc.IdentityUser, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListUsersByIDs", ctx, dollar_1)
	ret0, _ := ret[0].([]sqlc.IdentityUser)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockQuerierMockRecorder) ListUsersByIDs(ctx, dollar_1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListUsersByIDs", reflect.TypeOf((*MockQuerier)(nil).ListUsersByIDs), ctx, dollar_1)
}

// SearchUsers mocks base method.
func (m *MockQuerier) SearchUsers(ctx context.Context, arg sqlc.SearchUsersParams) ([]sqlc.IdentityUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) SetUserHousehold(ctx context.Context, arg sqlc.SetUserHouseholdParams) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetUserHousehold", ctx, arg)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockQuerier) SetUserSearchable(ctx context.Context, arg sqlc.SetUserSearchableParams) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetUserSearchable", ctx, arg)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockQuerierMockRecorder) SetUserSearchable(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
