...
- **2026-09-08** — `mobile-redesign-p3` begun. Branch `mobile-redesign-p3` created; scaffolded `AuthService`, `AuthGate`, `LoginScreen`, dashboard, grocery lists/detail, pantry, bottom-nav shell, `graphql_config` with `AuthLink`/`ErrorLink`, and updated `pubspec.yaml` and `clients/mobile/README.md`.
